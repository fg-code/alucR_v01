# Date: 15.3.2026 florian.gollnow@geo.hu-berlin.de
...
# demand | data.frame with demand for each land use class, columnes refer to lu, i.e. names ('lc7', 'lc4', 'lc3'), while sorting sould be similar to land use
# suitabilities rastestack lc | raster layer, integer values spatial | raster layer defining protected areas var.list epoche
